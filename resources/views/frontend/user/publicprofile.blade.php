                            ...
                            <div class="p-s-p-content">
                                <div class="row mt-minus-80">
                                    <div class="col-lg-12 text-right">
                                        <span style="text-transform: capitalize; @if(!empty(DB::table('categories')->where('name' , $r->question_subject)->get()->first()->text_color)) {{ DB::table('categories')->where('name' , $r->question_subject)->get()->first()->text_color  }}  {{ DB::table('categories')->where('name' , $r->question_subject)->get()->first()->backgroundcolor  }} @endif" class="badge badge-pill badge-warning">{{ $r->question_subject }}</span>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-md-12">
