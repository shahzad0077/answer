...
<script type="text/javascript">
const toggleSwitch = document.querySelector('.theme-switch-other input[type="checkbox"]');
const currentTheme = localStorage.getItem('theme');
...
<script type="text/javascript">
    $(window).scroll(function() {
        var scroll = $(window).scrollTop();
         //>=, not <=
        if (scroll >= 700) {
            $('#left-second-add').addClass('stickadd');
            $('#right-second-add').addClass('stickadd');
        }else{
            $('#left-second-add').removeClass('stickadd');
            $('#right-second-add').removeClass('stickadd');
        }
    }); //missing );
</script>
</html>
