            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Users Import</li>
                    </ol>
                </div>
                <h4 class="page-title">Users Import </h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form enctype="multipart/form-data" method="POST" action="{{ url('createfileusers') }}" class="needs-validation" novalidate>
                        {{ csrf_field() }}
                        <div class="form-group mb-3">
                            ...
                            <input style="height:45px;" accept=".xlsx" type="file" class="form-control" name="uploadedfile" id="validationCustom09"
                                 required>
                                 <input type="hidden" value="usersfile"  name="filetype"> 
                ...
                <div class="row">
                        <div class="col-md-12">
                            <table id="basic-datatable" class="table table-bordered">
                                ...
                                <tbody>
                                    @foreach(DB::table('uploadedfiledatas')->where('filetype' , 'usersfile')->get() as $r)
                                    <tr>
