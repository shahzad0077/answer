...
<div class="container-fluid">
    ...
    <ul class="nav nav-tabs nav-bordered mb-3">
        <li class="nav-item">
            <a href="{{ url('admin/all-pages') }}"  class="nav-link @if($viewstatus == 'all') active @endif">
        ...
        <li class="nav-item">
            <a href="{{ url('admin/all-pages/published') }}"  class="nav-link @if($viewstatus == 'published') active @endif">
        ...
        <li class="nav-item">
            <a href="{{ url('admin/all-pages/notpublished') }}"  class="nav-link @if($viewstatus == 'notpublished') active @endif">
                            ...
                            @foreach($data as $r)
                                <tr>
                                    ...
                                    <td class="table-action text-center">
                                        ...
                                        <a onclick="return confirm('Are You Sure You want to Delete This')" href="{{url('admin/deletepage')}}/{{ $r->id }}" class="action-icon" title="Delte Category"> <i class="mdi mdi-delete"></i></a>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
