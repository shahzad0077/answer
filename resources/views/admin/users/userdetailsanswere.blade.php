                ...
                <div class="card">
                    <div class="card-body">
                        <ul class="nav nav-tabs nav-bordered mb-3">
                            <li class="nav-item">
                                <a href="{{ url('admin/user/detail/') }}/{{$data->id}}"  class="nav-link ">
                                    <i class="mdi mdi-home-variant d-md-none d-block"></i>
                                    <span class="d-none d-md-block">All Questions</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ url('admin/user/detail/') }}/{{$data->id}}/answered"  class="nav-link active">
                            ...
                            <table id="basic-datatable" class="table table-bordered">
                                ...
                                <tbody>
                                     @foreach($questiondata as $r)
                                        <tr>
                                            <td><a href="{{ url('admin/viewquestion') }}/{{ $r->questionid }}">Q-{{ $r->questionid }}</a></td>
                                            <td><a onclick="answerview({{ $r->id }})" href="javascript:void(0)">A-{{ $r->id }}</a></td>
                                            <td>
                                               {!! Str::limit($r->answer  , 20) !!}
                                            </td>
                                            <td>
