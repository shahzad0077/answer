                        ...
                        <tbody>
                            ...
                            <tr @if($r->newstatus == 'new') style="background-color:#d0f2d0;" @endif>
                                <td>
                                    ...
                                    <a target="_blank" href="{{ url('') }}/{{ DB::table('blogs')->where('id' , $r->blogs)->get()->first()->url }}">{!! Str::limit(DB::table('blogs')->where('id' , $r->blogs)->get()->first()->name, 25) !!}</a>
                                    @endif
                                </td>
