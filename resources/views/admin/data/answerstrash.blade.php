...
<div class="container-fluid">
    ...
    <ul class="nav nav-tabs nav-bordered mb-3">
        ...
        <li class="nav-item">
            <a href="{{ url('admin/answers/trash') }}"  class="nav-link active">
                <i class="mdi mdi-settings-outline d-md-none d-block"></i>
                                       ...
                                       <form id="completeform" method="POST" action="">
                                        ...
                                        <tr @if(DB::table('abusivealerts')->where('answerid' , $r->id)->where('status' , 'Active')->count() == 1) style="background-color:#ffbc00;" @endif>
                                            ...
                                            <td class="table-action">
                                                ...
                                                <a onclick="return confirm('Are You Sure You want to Delete This')" href="{{url('admin/deleteanswerid')}}/{{ $r->id }}" href="javascript:void(0);" class="action-icon"> <i class="mdi mdi-delete"></i></a>
                                            </td>
                                        </tr>
                                        @endforeach  
                                        </form>                                     
