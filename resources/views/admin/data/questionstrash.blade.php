...
<div class="container-fluid">
    ...
    <ul class="nav nav-tabs nav-bordered mb-3">
        ...
        <li class="nav-item">
            <a href="{{ url('admin/questions/published') }}"  class="nav-link ">
        ...
        <li class="nav-item">
            <a href="{{ url('admin/questions/trash') }}" class="nav-link active">
                <i class="mdi mdi-settings-outline d-md-none d-block"></i>
                                       ...
                                       <form id="completeform" method="POST" action="">
                                        ...
                                        <tr>
                                            ...
                                            <td class="table-action">
                                                ...
                                                <a onclick="return confirm('Are You Sure You want to Delete This')" href="{{url('admin/deletequestionpermanently')}}/{{ $r->id }}" class="action-icon"> <i class="mdi mdi-delete"></i></a>
                                            </td>
                                        </tr>
                                        @endforeach  
                                        </form>                                     
