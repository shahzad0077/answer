                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="form-group mb-2">
                                                    ...
                                                    <div class="col-md-12">
                                                        @foreach(DB::table('adminmodulesparent')->get() as $p)
                                                            @php 
                                                                $child = DB::table('adminmoduleschild')->where('adminmodulesparent' , $p->id);
                                                            @endphp
                                                            ...
                                                            <label for="parent{{ $p->id }}">{{ $p->modulename }}</label>
                                                            </div>
                                                            <div style="padding-left: 30px;">
                                                            @if($child->count() > 0)
                                                                @foreach($child->get() as $c)
                                                                <div>
                                                                    <input class="parentid{{$p->id}}" @if(DB::table('roleschild')->where('userroles' , $r->id)->where('childid' , $c->id)->count() > 0) checked  @endif id="child{{$c->id}}" type="checkbox" value="{{$c->id}}" name="child[]">
                    ...
                    <div class="col-md-12">
                        @foreach(DB::table('adminmodulesparent')->get() as $r)
                            ...
                            <div>
                                ...
                                <label  for="parent{{ $r->id }}">{{ $r->modulename }}</label>
                            </div>
                            <div style="padding-left: 30px;">
                            @if($child->count() > 0)
                                @foreach($child->get() as $c)
